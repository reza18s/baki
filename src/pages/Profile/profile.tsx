...
export default function Profile() {
  ...
  return (
    ...
    >
      <div className="flex h-full w-full flex-col items-center gap-y-3 overflow-y-auto pb-16 text-brand-black">
        {/* Head */}
        <Link
          to="/explore"
        ...
        >
          ...
          <h1 className="my-auto text-lg font-bold">ویرایش پروفایل</h1>
          <div></div>
        </Link>
        {/* Body */}
        <div className="flex w-full flex-col items-center gap-y-3 px-6">
          <div className="w-full text-brand-black">
            <h2 className="mr-3 text-sm font-semibold text-[#64748B]">
              تکمیل پروفایل:
            </h2>
            <ArrowButton
          ...
          <div className="flex min-h-fit w-full flex-col items-center gap-y-3">
            ...
            <div className="w-full">
              <h2 className="mr-3 py-[8px] text-sm font-semibold text-[#64748B]">
                نام
              </h2>
              <TextInput
                placeholder="نام"
            ...
            <div className="w-full text-brand-black">
              <h2 className="mr-3 pb-[9px] pt-4 text-sm font-semibold text-[#64748B]">
                محل زندگی
              </h2>
              <ArrowButton
          ...
          <div className="w-full">
            <h2 className="text-gray-500 text-sm font-semibold mr-3 py-[8px]">
