...
const faq: {
  ...
  فنی: {
    ...
    register: {
      question: 'چگونه می‌توانم در اپلیکیشن ثبت نام کنم؟',
      answer:
        'در زمان ورود به اپلیکیشن با انتخاب گزینه «ورود و ثبت نام» و با وارد کردن شماره همراه خود به راحتی ثبت نام کنید و به تمامی امکانات رایگان اپلیکیشن دسترسی داشته باشید.',
    },
  },
};
