      ...
      <div className="w-full flex items-center justify-center">
        <Dropdown menu={{ items }} trigger={["click"]} className="w-full">
          <Button
            ...
            className="rounded-[12px] cursor-pointer border-[1.5px] border-[#1a1d1e] text-slate-400 text-base font-bold w-full h-[48px] flex items-center
                     justify-start"
          >
            <SolarIconSet.Magnifer size={24} />
            <p>استان محل زندگی خود را انتخاب کنید...</p>
          </Button>
        </Dropdown>
      </div>
      {/* Footer */}
