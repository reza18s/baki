...
export const Rules = ({ hideRules }: { hideRules: () => void }) => {
  return (
    <>
      <div className="relative flex w-full flex-col items-center gap-4 rounded-3xl bg-white px-6 text-justify text-sm">
        ...
        <div className="flex h-full w-full max-w-full flex-col gap-4">
          ...
          <p className="h-full max-h-[90%] w-full max-w-full text-sm font-medium leading-tight text-brand-black">
            ...
            <br />
            فیلدهای ثبت نام و تصویر کاربران پس از بررسی و تایید توسط مدیریت،
            برای سایر کاربران قابل مشاهده خواهد بود و درج هرگونه اطلاعات تماس
            (شماره موبایل، آیدی تلگرام و سایر شبکه های اجتماعی) در آنها تخلف
            محسوب می شود.
            <br />
            ...
            <br />
            جعل هویت اشخاص حقیقی و یا حقوقی اعم از شرکتها،نهادها وسازمانها و
            نسبت دادن بیانات و سخنان دروغین به ایشان مجاز
            <br />
            ...
            <br />
            عضویت در باکی به منزله پذیرش و تایید قوانین آن از طرف کاربران می
            باشد.
            <br />
            اپلیکیشن باکی خود را متعهد به حفاظت از حریم شخصی کاربران می‌داند.
            ...
            عنوان دارایی‌های که باید حداکثر حفاظت از آنها وجود داشته باشد ،
            محافظت خواهیم کرد.
            <br />
            ...
            حفظ و صیانت از اطلاعات شما را بعمل خواهیم آورد ولیکن اگر چنانچه به
            هر دلیل بدون اطلاع و رضایت شما اطلاعات شما توسط اشخاص ثالث مورد سوء
            استفاده و یا تخریب گردد ما مسئولیتی در مورد این اتفاقات نخواهیم
            داشت.
            <br />
            در پایان امیدواریم با همکاری شما عزیزان محیط پاک و سالمی در باکی
            داشته باشیم
          </p>
        </div>
      </div>
