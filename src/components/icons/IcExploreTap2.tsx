...
export const IcExploreTap2: FC<IconProps> = ({ className, ...props }) => {
  return (
    <svg
      width="30"
      height="30"
      ...
      {...props}
    >
      <circle cx="15" cy="15" r="12.5" stroke="#94A3B8" strokeWidth="1.875" />
      <path
        d="M6.95452 17.175C6.66885 16.1186 6.59405 15.0163 6.73439 13.931C6.87474 12.8457 7.22747 11.7986 7.77246 10.8496C8.31745 9.90064 9.04402 9.06829 9.91069 8.4001C10.7774 7.7319 11.7672 7.24095 12.8236 6.95528"
        stroke="#94A3B8"
        strokeWidth="1.875"
        strokeLinecap="round"
